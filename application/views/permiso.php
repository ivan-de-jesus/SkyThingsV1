                                                ...
                                                <div class="row">
                                                    <div class="col-5">
                                                        <div class="input-group">
                                                            ...
                                                            <select v-model='consulta.idlugar' v-bind:disabled="bloqueo" class="form-control">
                                                    ...
                                                    <div class="col-5">
                                                        <div class="input-group">
                                                            ...
                                                            <select v-model='consulta.idinvitado' v-bind:disabled="bloqueo" class="form-control">
                                                                <option disabled value="">Seleccione un invitado</option>
