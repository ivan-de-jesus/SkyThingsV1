...
<html lang="es-MX">
    ...
    <body>
        <div class="app" id="app">
            <div id="ctrl_camara">
                ...
                <div id="content" class="app-content box-shadow-z0" role="main">
                    ...
                    <encabezado titulo="Cámaras de seguridad"></encabezado>
                    ...
                    <div ui-view class="app-body" id="view">
                        ...
                        <div class="padding">
                            ...
                            <div class="row">
                                <div v-if='camaras.length === 0' class="col-xs-12 col-sm-12 col-lg-12">
                                    <div class="box p-a text-danger">
                                        <i class="fa fa-close"></i> No se encontraron cámaras disponibles.
                                    </div>
                                </div>
                            </div>

                            <div class="row">
                                <div v-for='(camara, index) in camaras' v-bind:key="index" class="col-sm-12 col-md-6 col-lg-6">
                                    <item-video v-bind:video="camara"></item-video>
                                </div>
                            </div>
        ...
        <script src="<?= base_url(); ?>js_vue/componente/items/item-video.js"></script>
        <script src="<?= base_url(); ?>js_vue/icomdomotica_camara.js"></script>
    </body>
</html>