...
<html lang="es-MX">
    ...
    <body>
                ...
                <div id="content" class="app-content box-shadow-z0" role="main">
                    ...
                    <div ui-view class="app-body" id="view">
                        ...
                        <div class="padding">
                            ...
                            <div id="accordionTopicos">
                                
                                <div class="collapse show">
                                    
                                    <div class="collapse show">
                                        <a class="card-link" data-toggle="collapse" data-parent="#accordionTopicos" href="#collapseRealTime">
                                            Tiempo real
                                        </a>
                                    </div>
                                    <div id="collapseRealTime" class="collapse show">
                                        <div class="card-body">
                                            
                                            <div v-if='topicosRealtime.length === 0' class="col-xs-12 col-sm-12 col-lg-12">
                                                <div class="box p-a text-danger">
                                                    <i class="fa fa-warning"></i> Sin controles de tipo Tiempo Real.
                                                </div>
                                            </div>
                                            
                                            <div class="row">
                                                <control-item-realtime 
                                                    v-for="(topico, index) in topicosRealtime" 
                                                    v-bind:key="index" 
                                                    v-bind:mqttclient="mqttclient" 
                                                    v-bind:topico="topico"></control-item-realtime>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="collapse show">
                                    ...
                                    <div class="collapse show">
                                        <a class="card-link" data-toggle="collapse" data-parent="#accordionTopicos" href="#collapseRange">
                                            Rango
                                        </a>
                                    </div>
                                    <div id="collapseRange" class="collapse show">
                                        <div class="card-body">
                                            
                                            <div v-if='topicosRange.length === 0' class="col-xs-12 col-sm-12 col-lg-12">
                                                <div class="box p-a text-danger">
                                                    <i class="fa fa-warning"></i> Sin controles de tipo rango.
                                                </div>
                                            </div>
                                            
                                            <div class="row">
                                                <control-item-range 
                                                    v-for="(topico, index) in topicosRange" 
                                                    v-bind:key="index" 
                                                    v-bind:mqttclient="mqttclient" 
                                                    v-bind:topico="topico"></control-item-range>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="collapse show">
                                    ...
                                    <div class="collapse show">
                                        <a class="card-link" data-toggle="collapse" data-parent="#accordionTopicos" href="#collapseSwitch">
                                            Switch
                                        </a>
                                    </div>
                                    <div id="collapseSwitch" class="collapse show">
                                        <div class="card-body">
                                            
                                            <div v-if='topicosSwitch.length === 0' class="col-xs-12 col-sm-12 col-lg-12">
                                                <div class="box p-a text-danger">
                                                    <i class="fa fa-warning"></i> Sin controles de tipo Switch.
                                                </div>
                                            </div>
                                            
                                            <div class="row">
                                                <control-item-switch 
                                                    v-for="(topico, index) in topicosSwitch" 
                                                    v-bind:key="index" 
                                                    v-bind:mqttclient="mqttclient" 
                                                    v-bind:topico="topico"></control-item-switch>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script src="<?= base_url(); ?>node_modules/vue-svg-gauge/dist/vue-svg-gauge.min.js"></script>
        ...
        <script src="<?= base_url(); ?>js_vue/componente/ChartLineRealtime.js"></script>
